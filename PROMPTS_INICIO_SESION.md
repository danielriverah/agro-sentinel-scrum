...
3. docs/DYNAMODB_CONFIG.md          → estructura exacta de la configuración
4. docs/ERRORES.md                  → códigos de error y excepciones
5. DEFINITION_OF_DONE.md           → criterios que debe cumplir todo código entregado
6. PRODUCT_BACKLOG.md              → historias de usuario y sus criterios de aceptación
7. sprints/[área]/SPRINT_[N].md    → el sprint activo (ver tabla de estado en README.md)
